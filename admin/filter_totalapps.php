    ...
    <table id="appointments">
        ...
        <tbody>
            ...
            if (isset($_GET['searching'])) {
                $search_totalapps = $_GET['searching'];
            }
            $db = mysqli_connect('localhost', 'Valerian', '#Valeriephyl254', 'darms');
            $query = "SELECT * FROM appointment JOIN patient ON appointment.patientid=patient.patient_id AND appointment_date LIKE '%$search_totalapps%'";
