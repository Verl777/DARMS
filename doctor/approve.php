    ...
    <table id="appointments">
        ...
        <tbody>
            ...
            while ($row = mysqli_fetch_assoc($select_all_appointments)) {
                ...
                echo "<td><a class='edit' href='appointment.php?edit={$appointment_id}'>Approve</a></td>";
                echo "<td><a class='delete' href='appointments.php?delete={$appointment_id}'>Deny</a></td>";
                echo "</tr>";
            }
            ?>
        </tbody>
